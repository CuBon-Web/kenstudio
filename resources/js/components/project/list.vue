        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
              <h4 class="card-title mb-0">Danh sách dự án</h4>
              <vs-button
                type="gradient"
                :disabled="!$hasPermission('project.create')"
                @click="$goIfAllowed('project.create', { name: 'add_project' }, 'Bạn không có quyền thêm mới dự án.')"
              >Thêm mới</vs-button>
            </div>
            ...
            <div class="d-flex flex-wrap mb-3" style="gap:12px;align-items:flex-end">
              <div style="flex:1;min-width:180px;max-width:300px">
                ...
                <el-input placeholder="Nhập tên dự án..." v-model="keyword" clearable />
              </div>
            ...
            <transition name="fade">
              <div v-if="selected.length > 0" class="bulk-bar mb-2">
                <span class="bulk-count">Đã chọn {{ selected.length }} dự án</span>
...
export default {
  ...
  methods: {
    ...mapActions(['listProject', 'deleteProject', 'bulkDeleteProject', 'toggleProjectField', 'listProjectCate', 'loadings']),
    ...
    confirmBulkDelete() {
      this.$vs.dialog({
        ...
        title: 'Xóa ' + this.selected.length + ' dự án?',
